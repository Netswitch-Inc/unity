...
const Attachments = () => {
  ...
  return (
    <>
      {allowed && <div className={"attachment-container"} onDrop={handleDrop}
      ...
      <div>
            ...
            <div key={item._id} className={"attachment-item mt-2 d-flex align-items-baseline"}>
              <div className="w-75">
                {/* <img
                    ...
                    src={`${process.env.REACT_APP_BACKEND_REST_API_URL}${item.file_path}`}
                    alt={"attachments-img"}
                  /> */}
              ...
              <div className="w-25 text-right">
                <FaDownload className="m-0 download-image cursor-pointer text-white" onClick={() => downloadAttachmentHandler(`${process.env.REACT_APP_BACKEND_REST_API_URL}/${item.file_path}`, item?.name)}
                  width={20}
                  height={20} />
                {/* <img
                  alt={"attachments-img"}
                  className={"download-image cursor-pointer"}
                  src={
                    "data:image/png;base64,"
                  }
        ...
        {
          store?.attachmentItems?.length === 0 && <p>There are no records to display</p>
        }
      </div>
    </>
  );
