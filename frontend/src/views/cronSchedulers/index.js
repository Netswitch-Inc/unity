...
const CronSchedulerList = () => {
    ...
    const handleCronSchedulerLists = useCallback((sorting = sort,
    ...
    const columns = [
        ...
        },
        {
            ...
            selector: (row) => (
                row?.status ? (
                    <span className="badge badge-pill badge-primary">Enabled</span>
                ) : (
                    <span className="badge badge-pill badge-warning">Disabled</span>
                )
            )
        },
        {
